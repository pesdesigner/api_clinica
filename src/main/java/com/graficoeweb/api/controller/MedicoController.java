...
import com.graficoeweb.api.domain.medico.*;
...
public class MedicoController {
    ...
    public ResponseEntity cadastrar(@RequestBody @Valid DadosCadastroMedico dados, UriComponentsBuilder uriBuilder) {
        ...
        return ResponseEntity.created(uri).body(new DadosDetalhamanetoMedico(medico));
    }
    ...
    public ResponseEntity atualizar(@RequestBody @Valid DadosAtualizarMedico dados) {
        ...
        return ResponseEntity.ok(new DadosDetalhamanetoMedico(medico));
    }
